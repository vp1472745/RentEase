...
import MobileMenu from "../../component/navbar/MobileMenu.jsx";
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              {profileImage && profileImage !== useri ? (
                ...
                <div className="w-full h-full flex items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white  font-bold text-xl border shadow-inner">
                  {getInitial()}
                </div>
              )}
            </button>
              ...
              >
                ...
                >
                  {profileImage && profileImage !== useri ? (
                    ...
                    <div className="w-14 h-14 flex items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-md mt-1 font-mono font-bold text-2xl border-2 border-gray-200 shadow-md">
                      {getInitial()}
                    </div>
                  )}
                  <div className="ml-4 flex-1">
                    <p className="font-bold text-lg text-gray-900 flex items-center">
                      ...
                      <FaBriefcase className="ml-2 text-indigo-600" size={16} />
                    </p>
                  ...
                  <button
                    ...
                    className="p-2 text-gray-400 hover:text-indigo-600  rounded-full transition-all duration-300"
                  >
                ...
                >
                  <div
                    className="relative hover:bg-indigo-50 rounded-lg transition-all duration-300"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <button
                      onClick={(e) => {
                      ...
                      className="w-full text-left px-4 py-3 transition-all duration-300 flex items-center justify-between text-indigo-700 cursor-pointer font-medium"
                    >
                  ...
                  {isQuickSearchOpen && (
                    ...
                    >
                      <Link
                        ...
                        className="flex flex-col items-center p-3 hover:bg-indigo-50 rounded-xl border border-gray-200 hover:border-purple-300 transition-all duration-300 min-w-[80px]"
                      >
                ...
                >
                  <div
                    className="relative hover:bg-indigo-50 rounded-md"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <button
                      onClick={(e) => {
                      ...
                      className="text-lg mt-2 transition flex items-center w-83 ml-2 hover:border-indigo-800 hover:bg-indigo-50 cursor-pointer rounded-md"
                    >
                      <FaRegHeart className="w-5 h-5 ml-1" />
                      <span className="px-4 text-[16px] py-2 mr-auto text-indigo-600  hover:text-black">
                      ...
                      {savedPropertiesLoading ? (
                        ...
                        <div className="space-y-3">
                          {savedProperties.map((property) => (
                            <div
                              key={property._id}
                              className="flex items-center p-3 hover:bg-indigo-50 rounded-lg cursor-pointer border border-gray-200 shadow-sm transition-all duration-200 hover:shadow-md"
                              onClick={() => {
                            ...
                            >
                              <div className="w-16 h-16 rounded-lg overflow-hidden flex-shrink-0 border border-gray-200">
                                ...
                                <div
                                  className="w-full h-full bg-gradient-to-br from-indigo-100 to-indigo-100 flex items-center justify-center"
                                  style={{
                                    display:
                                      property.media &&
                ...
                >
                  ...
                  >
                    <button
                      ...
                      className="text-lg mt-2 transition flex items-center w-83 ml-2 text-black-800 hover:border-purple-800 hover:bg-indigo-50 cursor-pointer rounded-md"
                    >
                      <img src={services} className="w-6 h-6 ml-1 text-indigo-600" alt="" />
                      <span className="px-4 text-[16px] py-2 mr-auto text-indigo-600 hover:text-indigo">
                        Services
                      </span>
                      <MdOutlineKeyboardArrowUp
                        size={16}
                  ...
                  {isServicesOpen && (
                    ...
                    >
                      <Link
                        ...
                        className="flex flex-col items-center p-2 hover:border-purple-800 border-3 hover:bg-indigo-50 rounded h-20 w-20"
                      >
                        <IoHomeOutline size={24} className="text-indigo-600" />
                        <span className="text-sm text-center text-indigo-600">
                          Home <br /> Rent
                        </span>
                      </Link>
                      <Link
                        ...
                        className="flex flex-col items-center p-2 hover:border-purple-800 border-3 hover:bg-indigo-50 rounded h-20 w-22"
                      >
                        <IoBusinessOutline size={22} className="text-indigo-600" />
                        <span className="text-sm text-center text-indigo-600 text-[13px]">
                          Post properties
                        </span>
                      </Link>
                    </div>
                ...
                <Link
                  ...
                  className="w-85 rounded-md text-left px-3 py-2 text-indigo hover:bg-indigo-50 flex items-center cursor-pointer"
                >
                  <PiDetective size={20} className="ml-1 " />
                  <span className="text-indigo-600 hover:text-black px-4">
                    Report a Fraud
                  </span>
                </Link>
                ...
                <button
                  ...
                  className="w-80 ml-3 rounded-md text-left px-4 py-2 mt-3 text-indigo-600 hover:text-indigo hover:border-purple-800 hover:bg-indigo-50 flex items-center cursor-pointer border"
                >
          ...
          <div className="relative" ref={authMenuRef}>
            <button
              ...
              className={`px-6 py-2.5 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105 ${
                isScrolled
                  ? "bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-md mt-1 font-mono"
