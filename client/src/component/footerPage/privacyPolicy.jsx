...
const PrivacyPolicy = () => (
  <div className="min-h-screen bg-[#f8fafc] flex flex-col items-center">
    ...
    <div className="w-full  bg-purple-800 flex items-center h-18 justify-center shadow-md sticky top-0 z-20">
    </div>
    {/* Main Card Container */}
    <div className="w-full max-w-3xl bg-white rounded-2xl shadow-xl p-8 border border-gray-100 mt-10 mb-16">
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 leading-relaxed">'Room Milega' ("we", "us", or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services.</p>
      </section>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc list-inside text-gray-600 space-y-1">
          ...
          <li>We may share information to protect the rights, property, or safety of 'Room Milega', our users, or others.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-600 leading-relaxed">If you have any questions or concerns about this Privacy Policy or our data practices, please contact us at <a href="mailto:roommilega1611@gmail.com" className="hover:text-yellow-400">roommilega1611@gmail.com</a>.</p>
      </section>
    </div>
  </div>
);
