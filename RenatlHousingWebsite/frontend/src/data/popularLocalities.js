const popularLocalitiesData = {
  Mumbai: ["Bandra West", "Powai", "Andheri West", "Juhu", "Lower Parel"],
  ...
  Bhopal: ["Arera Colony", "MP Nagar", "Kolar Road", "Hoshangabad Road", "Shahpura"],
  ...
  Faridabad: ["Sector 14", "Sector 15", "Sector 21C", "Greenfield Colony", "Neharpar"],
  Pune: ["Koregaon Park", "Kothrud", "Viman Nagar", "Baner", "Hinjewadi"],
  NaviMumbai: ["Vashi", "Kharghar", "Belapur", "Nerul", "Airoli"],
  Indore: ["Vijay Nagar", "Rajwada", "Saket Nagar", "Palasia", "Sudama Nagar"],
  Ghaziabad: ["Indirapuram", "Raj Nagar Extension", "Vaishali", "Kaushambi", "Crossings Republik"],
...
// ✅ Correct Export
export default popularLocalitiesData;
