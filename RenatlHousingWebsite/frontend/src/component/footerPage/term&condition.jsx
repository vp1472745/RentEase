      ...
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-xl p-8 border border-gray-100 mt-10 mb-16">
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-600 leading-relaxed">
            Welcome to RentEase! By accessing or using our website and services, you agree to be bound by these Terms & Conditions ("Terms") and our Privacy Policy. If you do not agree to these Terms, please do not use our services.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            ...
            <li>RentEase does not endorse any user, property, or listing. We are not a party to any rental agreement between users.</li>
            <li>You grant RentEase a non-exclusive, worldwide, royalty-free license to use, host, store, reproduce, and display content you submit (e.g., property photos).</li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            ...
            <li>Payments are processed through a third-party payment gateway. RentEase is not responsible for any issues arising from the payment process.</li>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-600 leading-relaxed">
            Our services are provided "as is" and "as available" without any warranties. RentEase is not liable for any direct, indirect, incidental, or consequential damages arising from your use of our platform or any transaction between users.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            If you have any questions about these Terms, please contact us at <a href="mailto:support@rentease.com" className="text-purple-800 underline">support@rentease.com</a>.
          </p>
        </section>
      </div>
    </div>
