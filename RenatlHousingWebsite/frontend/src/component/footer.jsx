        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 border-b border-gray-700 pb-10">
            ...
            <div className="flex flex-col items-start">
              <img src={logo} alt="RentEase Logo" className="w-36 mb-4" />
              <p className="text-gray-300 text-sm leading-relaxed">
                RentEase is your trusted partner for finding and listing rental properties. Enjoy zero brokerage, verified listings, and a seamless rental experience.
              </p>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mt-8 text-sm text-gray-400">
            <div className="mb-2 md:mb-0">&copy; {new Date().getFullYear()} RentEase Rentals Pvt. Ltd. All rights reserved.</div>
