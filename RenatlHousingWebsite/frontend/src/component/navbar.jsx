...
function Navbar({ isAuthenticated, setIsAuthenticated, user, setUser }) {
  ...
  return (
    ...
    {isAuthenticated && user ?  (
      ...
      <div className="relative" ref={profileRef}  onClick={() => setIsCardOpen(!isAuthenticated)}>
        <button
        ...
        {isProfileOpen && (
          <div className="absolute right-0 mt-2 w-90 bg-white shadow-lg rounded-lg py-2 overflow-y-auto max-h-130 custom-scrollbar">
            ...
            <div className="hover:bg-purple-300 flex rounded-md ">
              <IoDiamondOutline className="mt-3 ml-3" size={20} />
              <Link
                to="/premium"
                className="block px-4 py-2  text-black-800 text-purple-800   hover:text-black  "
              >
            ...
            <div className="hover:bg-purple-300 flex rounded-md ">
              ...
              <Link
                ...
                className="block px-5 py-2   hover:text-black  text-purple-800"
              >
                {" "}
                My Transactions
              </Link>
            ...
            <div className="hover:bg-purple-300 flex rounded-md ">
              ...
              <Link
                to="/profile?tab=myTransactions"
                className="block px-4 py-2   hover:text-black cursor-pointer  text-purple-800 "
              >
                {" "}
                My Review
              </Link>
            ...
            >
              <div className="relative hover:bg-purple-300 rounded-md ">
                <button
              ...
              {isQuickSearchOpen && (
                <div className="mt-2 w-80 h-22 rounded-md py-2 flex flex-wrap gap-2 p-2">
                  <Link
                    to="/buy"
            ...
            {/* <div className="hover:bg-blue-100 flex ">
              <TbReportMoney className="mt-3 ml-3" />
              <Link
                to=""
                className="block px-2 py-2   hover:text-blue-800  text-black-800"
              >
                {" "}
                Residential Pages
              </Link>
            ...
            >
              ...
              {/* Housing Edge Dropdown */}
              {isHousingOpen && (
                <div className="mt-2 w-83 h-22  rounded-md py-2 flex flex-wrap p-2 gap-2 ">
                  <Link
                    to="/pay-rent"
                    className="flex flex-col items-center p-2 hover:border-purple-800 border-3 hover:bg-purple-50 rounded  h-18 w-20"
                  >
            ...
            >
              <div className="relative  hover:bg-purple-300 rounded-md ">
                ...
                >
                  ...
                  <span className="px-4 text-[16px] py-2 mr-auto text-purple-800 hover:text-black">Services</span>
                  <MdOutlineKeyboardArrowUp
                    size={16}
                    className={`mr-2 ${
              ...
              {/* Services Dropdown */}
              {isServicesOpen && (
                <div className="mt-2 w-80 rounded-md py-2 flex flex-wrap gap-2 p-2">
                  <Link
                    to="/home-loan"
                  ...
                  {/* <Link to="/legal-services" className="flex flex-col items-center p-2 hover:border-blue-800 border-2 rounded bg-blue-50 h-18 w-20">
    <IoDocumentTextOutline size={22} />
    <span className="text-sm text-center text-black-800">
      Legal <br /> Services
    </span>
  </Link> */}
                  {/* <Link to="/property-valuation" className="flex flex-col items-center p-2 hover:border-blue-800 border-2 rounded bg-blue-50 h-18 w-20"> */}
                  {/* <IoPricetagOutline size={22} />
    <span className="text-sm text-center text-black-800">
      Property <br /> Valuation
    </span>
  </Link> */}
                  {/* <Link to="/interior-design" className="flex flex-col items-center p-2 hover:border-blue-800 border-2 rounded bg-blue-50 h-18 w-20">
    ...
    <span className="text-sm text-center text-black-800">
      Interior <br /> Design
            ...
            <div className=" flex hover:border-purple-800 hover:bg-purple-300 rounded-md ">
              <CiBellOn className="mt-2 ml-3" size={20} />
              <Link
                to="/reviews"
                className="block px-4 py-2 text-purple-800 hover:text-black   "
              >
                Unsubscribe Alert
              </Link>
            </div>
            ...
            <span className=" text-purple-800 hover:text-black px-4">Report a Fraud</span>  
            ...
            <span className="ml-2 text-purple-800 hover:text-black">Vist Help Center</span>  
            ...
            <div className="bg-white p-4 md:p-6 rounded-xl  w-full max-w-md mx-auto">
