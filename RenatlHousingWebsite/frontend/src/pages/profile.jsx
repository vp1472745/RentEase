    ...
    switch (selectedSection) {
      case "myTransactions":
        return (
          <>
              <div
                className="absolute inset-0 bg-cover bg-center h-15 bg-purple-800  "
                // style={{
                //   backgroundImage: `url(${hotel})`,
                //   filter: "brightness(50%)",
                // }}
              ></div>
              <div className="border-2 border-purple-800 h-140 rounded">
            <h2 className="text-2xl font-bold mt-5 px-2 ">My Transactions</h2>
            <div className="flex gap-4 mt-5 px-2 ">
      ...
      case "myProperties":
        return (
          <>
            <div className="bg-white h-140 rounded-md border-2 border-purple-800 shadow-lg">
            <div
                className="absolute inset-0 bg-cover bg-center h-15 bg-purple-800"
                // style={{
                //   backgroundImage: `url(${hotel})`,
                ...
                // }}
              ></div>
              <h2 className="text-2xl font-bold  px-2">My Properties</h2>
            </div>
          </>
        );
      case "myReviews":
        return (
          <>
            <div className="bg-white h-140 border-2 border-purple-800 rounded">
            <div
                className="absolute inset-0 bg-cover bg-center h-15 bg-purple-800"
                // style={{
                //   backgroundImage: `url(${hotel})`,
                ...
                // }}
              ></div>
              <h2 className="text-2xl font-bold px-2 ">My Reviews</h2>
            </div>
          </>
        );
      case "myactivity":
        return (
          <>
            <div className="bg-white shadow-lg h-140 border-2 border-purple-800 rounded">
              <div
                className="absolute inset-0 bg-cover bg-center h-15 bg-purple-800"
                // style={{
                //   backgroundImage: `url(${hotel})`,
                ...
                // }}
              ></div>
              <h2 className="text-2xl font-bold px-2 ">My Activity</h2>
                ...
                <div className="p-6 h-[600px] bg-white shadow-lg w-[700px] ml-5 rounded border-2 border-purple-800">
                  ...
                  {/* <div className="bg-white p-4 rounded-md  mt-4 ">
                    ...
                    <button 
                      ...
                      className="mt-3 px-4 py-2 bg-purple-800 font-bold hover:bg-purple-400 hover:text-black text-white rounded w-[50] cursor-pointer"
                    >
                      Save
                    </button>
                  </div> */}
