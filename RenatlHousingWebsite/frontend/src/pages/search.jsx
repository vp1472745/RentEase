...
const SearchBar = () => {
  ...
  useEffect(() => {
    console.log("Filtering with localityFilter:", locality);
  ...
  return (
    <div className="flex flex-col items-center w-full mt-8 py-8 px-4 sm:px-6 lg:px-8  min-h-[40vh]">
      ...
      <div className="flex flex-col sm:flex-row items-center w-full max-w-2xl bg-white/80 shadow-xl rounded-2xl px-4 py-4 border border-purple-100 backdrop-blur-md">
        {/* City Selector */}
        <button
          onClick={() => setIsModalOpen(true)}
          className="flex items-center gap-2 text-lg font-semibold text-purple-800 bg-purple-100 hover:bg-purple-200 transition px-4 py-2 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-300 mb-3 sm:mb-0 sm:mr-4"
        >
          <span>{city}</span>
          <RiArrowDropDownLine className="h-7 w-7 text-purple-700" />
        </button>
        {/* Divider */}
        <div className="hidden sm:block h-10 w-px bg-purple-200 mx-4" />
        {/* Locality Input */}
        <input
          type="text"
          className="flex-grow w-full px-5 py-3 text-lg text-gray-800 bg-white rounded-xl border border-purple-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 shadow-sm transition placeholder-gray-400 outline-none"
        ...
        <button
          ...
          className="mt-3 sm:mt-0 ml-0 sm:ml-4 flex items-center gap-2 bg-gradient-to-r from-purple-700 to-purple-500 hover:from-purple-800 hover:to-purple-600 text-white font-bold px-6 py-3 rounded-xl shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-300 text-lg"
        >
